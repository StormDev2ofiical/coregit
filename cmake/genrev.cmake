...
if(WITHOUT_GIT)
  set(rev_date "Разработчик:StormDev2")
  set(rev_hash "Server:wow-git")
  set(rev_branch "relase 1.6")
else()
  if(GIT_EXECUTABLE)
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"Server:wow-git Разработчик:StormDev2 (relase 1.6)\"")
    set(rev_date "Разработчик:StormDev2")
    set(rev_hash "Server:wow-git")
    set(rev_branch "relase 1.6")
  else()
